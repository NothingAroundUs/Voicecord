...
function Updater() {
    ...
    return (
        <SettingsTab title="Voicecord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Voicecord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Voicecord automatically updates"
